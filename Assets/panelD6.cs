...
public class HistoricalDataPanelScene3 : MonoBehaviour
{
    ...
    private void CreateHistoryPanel()
    {
        ...
        descriptionText.text = "<b>Técnica Inca:</b> El tallado de sillería ('Ashlar') permitía que las piedras encajaran milimétricamente\n\n" +
            "<b>Sostenibilidad:</b> Las terrazas agrícolas (andenes) no solo producían alimentos, sino que evitaban los deslizamientos del terreno montañoso\n\n" +
            "<b>Red de Caminos:</b> Estaba conectada directamente al Qhapaq Ñan (Gran Camino Inca), la red que unía a todo el imperio\n\n";
