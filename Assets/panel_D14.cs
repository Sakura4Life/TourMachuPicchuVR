...
public class HistoricalDataPanel6 : MonoBehaviour
{
    ...
    private void CreateHistoryPanel()
    {
        ...
        descriptionText.text = "<b>Nombre Original:</b> Su denominación real en la época incaica se ha perdido, ya que 'Machu Picchu' es un término quechua contemporáneo que significa 'Montaña Vieja'\n\n" +
        "\n\n" +
        "<b>Ingeniería Sísmica:</b> Los muros de los edificios principales están ligeramente inclinados hacia adentro para absorber de manera óptima las ondas sísmicas de la región"; 
