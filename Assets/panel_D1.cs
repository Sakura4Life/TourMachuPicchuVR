...
public class HistoricalDataPanelScene2 : MonoBehaviour
{
    ...
    private void CreateHistoryPanel()
    {
        ...
        descriptionText.text = "<b>Resistencia:</b> Edificaciones antisísmicas donde las piedras 'bailan' durante los terremotos y vuelven a encajar perfectamente\n\n" +
            "<b>Preservación:</b> Nunca fue descubierta por los conquistadores españoles, lo que permitió que se mantuviera intacta\n\n" +
            "<b>Cimentación:</b> Más del 60% de la ciudad es subterránea, sirviendo como un sofisticado sistema de drenaje";
