...
public class HistoricalDataPanel : MonoBehaviour
{
    ...
    private void CreateHistoryPanel()
    {
        ...
        titleText.text = "Panel Histórico - Machu Picchu";
        ...
        descriptionText.text = "<b>Ubicación:</b> Región andina, Perú\n\n" +
            "<b>Construcción:</b> Aproximadamente en 1450, durante el reinado de Pachacútec\n\n" +
            "<b>Función:</b> Residencial, ceremonial y administrativa\n\n" +
            "<b>Arquitectura:</b> Terrazas, templos, plazas y viviendas de piedra tallada sin mortero";
