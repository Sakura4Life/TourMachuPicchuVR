...
public class HistoricalDataPanel5 : MonoBehaviour
{
    ...
    private void CreateHistoryPanel()
    {
        ...
        titleText.text = "Datos Históricos - Machu Picchu";
        ...
        descriptionText.text = "<b>Población:</b> Albergaba una población de entre 300 y 1000 personas, compuesta principalmente por la élite y especialistas (mitimaes)\n\n" +
        "\n\n" +
        "<b>Redescubrimiento:</b> Dada a conocer al mundo científico en 1911 por el explorador estadounidense Hiram Bingham, aunque locales ya la conocían";
