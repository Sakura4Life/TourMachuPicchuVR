...
public class HistoricalDataPanel7 : MonoBehaviour
{
    ...
    private void CreateHistoryPanel()
    {
        ...
        descriptionText.text = "<b>Piedras Intactas:</b> El diseño inclinado de las ventanas y puertas trapezoidales reduce el impacto de los movimientos telúricos, una de las razones por las que la ciudadela se mantiene en pie\n\n" +
        "<b>Piedra del Cóndor:</b> Una roca tallada de forma natural que emula las alas desplegadas de un cóndor andino, debajo de la cual se encuentra una pequeña cueva que sirvió para fines ceremoniales o de momificación";
